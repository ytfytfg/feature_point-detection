...
predictor_Blink = dlib.shape_predictor(facial_landmarks_predictor)
...
keys_set_1 = {0: "B", 1: "W", 2: "E", 3: "R", 4: "T",
              5: "A", 6: "S", 7: "D", 8: "F", 9: "G",
...
def Left_or_Right(face_locations, height_ratio, width_ratio):
    ...
    if len(face_locations):
        ...
        shape = predictor_Blink(gray, dlib.rectangle(x1, y1, x2, y2))
        ...
        if left_eye_open == 'yes' and right_eye_open == 'no': return 'L'
        elif right_eye_open == 'yes' and left_eye_open == 'no': return 'R'
        else: return -1
...
select_keyboard_menu = True #Control Left Right Menu
...
while True:
    ...
    if select_keyboard_menu is False:
        if frames == frames_active_letter:
            print("frames == frames_active_letter")
            #letter_index += 1

            try:
                move = Left_or_Right(face_locations, height_ratio, width_ratio)
